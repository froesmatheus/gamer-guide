...
class MyGamesFragment : DaggerFragment() {
    @Inject
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory).get(MyGamesViewModel::class.java)
        ...
        fab.setOnClickListener {
            startActivity(Intent(context(), AddGamesActivity::class.java))
        }
